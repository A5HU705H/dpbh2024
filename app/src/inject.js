...
function letUserSelectElement(request, sender, sendResponse) {
  ...
  document.addEventListener(
    ...
    (event) => {
      ...
      modal.textContent = 'What dark patterns did you notice?';

      // add padding to the modal
      modal.style.marginLeft = '25%';
      modal.style.paddingLeft = '2%';
      modal.style.marginRight = '25%';
      modal.style.paddingRight = '2%';
      modal.style.marginTop = '25%';
      modal.style.paddingTop = '2%';
      modal.style.marginBottom = '25%';
      ...
      submit.style.marginLeft = '20%';
      submit.style.marginRight = '20%';
      ...
      submit.addEventListener('click', () => {
        chrome.runtime.sendMessage({
          ...
          patterns: Array.from(document.querySelectorAll('.selected')).map(
            (darkPattern) => darkPattern.textContent
          ),
        });
